...
- [x] 1.3 Open a Codespace from this branch and verify `pants list ::`, `pants dependencies internal/search::`, and `pants --changed-since=HEAD~1 --changed-dependents=transitive list` all run without manual setup
